"""
智能浏览器 - Playwright(Firefox) + MiniMax 决策层
用法:
...
class SmartBrowser:
    def __init__(self):
        self.llm = OpenAI(
            api_key='sk-api-JFeCFE27VZYICiKzMQMCypwf3Jyg0hNfFbEqIMW638C-UHh3ldpawfBfn8sq8IwOXAMTH4-_rjqlMuTlXq5WxcS2g8Zi_9iHs6ZKOOM5908yjk-y6qHDq-c',
    ...
    def ask_llm(self, instruction, page_context="", max_tokens=200):
...
async def main():
    if len(sys.argv) < 2:
        print("用法: python smart_browser.py <任务>")
        return
